...
//        holder.calltype.setText(callModels.get(position).getCallername());
//
...
public class CallAdapter extends RecyclerView.Adapter<CallAdapter.ViewHolder> {
    Context context;
    ArrayList<CallModel> callModels;
    ArrayList<CallModel> filteredCallModel;

    private static final int REQUEST_CODE_CALL_PHONE = 1;

    public CallAdapter(Context context, ArrayList<CallModel> callModels, ArrayList<CallModel> filteredCallModels) {
        this.context = context;
        this.callModels = callModels;
        this.filteredCallModel=filteredCallModels;
    }
    public CallAdapter(Context context, ArrayList<CallModel> callModels) {
        this.context = context;
        this.callModels = callModels;
    ...
    public void updateList(ArrayList<CallModel> filteredCallModels) {
        callModels=filteredCallModels;
